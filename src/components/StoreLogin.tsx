...
const StoreLogin = () => {
   ...
   const closeHamburger = () => {
    ...
    return (
       <section>
          <HamburgerMenu isActive={hamburgerActive} onClose={closeHamburger} />
          <div className="store-login">
             <div
                className={`mobile-hamburger is-lg ${
             ...
             <img
                className="store-login-lightcart"
                src={light_car_icon}
                alt="light car icon"
             />
             ...
             <div
                className={`store-login-dropdown ${
